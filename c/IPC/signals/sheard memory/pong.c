...
const char ECHO_RCV[] = "PID:%d Pong Rcv from PID:%lu %ld bytes:'%s'\n";
const char ECHO_MESSAGE[] = "Pong Message #%2d\n";
...
int main(int argc, char *argv[])
{
    ...
    if (-1 == (pingSemId = semget(PING_KEY, 1, (IPC_EXCL | sg_DEFAULT_PERMISSIONS))))
    {
