 ...
 * or g_wrongItr if _predicate is NULL
 */
 ...
 * returns g_wrongItr if _action is NULL
 */
 ...
 * 
 */
void ListItrSort (ListItr _begin, ListItr _end, LessFunction _less); /* lessFunc should have a generic name */
