...
typedef Card (*Strategy)(const int *_table, Hand *_hand);
/* #include "strategy.h" */
...
Input:
		Player* _player: pointer to Player.
		size_t* _score: address where retrieved score will be stored.
Output:
		Status ERR_OK.
Errors:
		If _player or _score are NULL -> ERR_NOT_INITIALIZED is returned.
*/
