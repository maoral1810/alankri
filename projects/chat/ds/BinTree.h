...
extern BSTreeItr g_wrongIter;

typedef int (*LessComparator)(void* _left, void* _right);

/** 
 * @brief Predicate function returns a zero value if predicate holds for element
 *
...
BSTreeItr BSTreeFindFirstItr(BSTreeItr _it, PredicateFunction _predicate, void* _context);
